      ...
      <div className="section-container relative z-10">
        ...
        >
          ...
          <p className="text-gray-400 text-base sm:text-lg leading-relaxed max-w-lg">
            Let&apos;s discuss your business goals and design a high-converting digital experience. We usually respond within a few hours.
          </p>

          <div className="flex flex-col sm:flex-row items-center gap-4 w-full justify-center mt-3 px-4 sm:px-0">
            ...
            <motion.a
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 font-semibold rounded-xl transition-all duration-300 cursor-pointer whitespace-nowrap px-8 py-4 text-lg bg-emerald-600 hover:bg-emerald-500 text-white shadow-[0_0_20px_rgba(16,185,129,0.3)] border border-emerald-500/30"
          ...
          <p className="text-gray-500 text-xs mt-3">
            Flexible pricing for startups and growing businesses. No obligation.
          </p>
        </motion.div>
      </div>
    </section>
